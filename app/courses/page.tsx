...
const courses = [
  ...
  overview: "Gain hands-on exposure to Oracle ERP Cloud Financials — from ledger setup to intelligent reconciliation — while understanding how AI improves accuracy, forecasting, and decision-making in finance operations.",
  curriculum: [
  ...
  outcomes: "Develop practical skills in configuring, analyzing, and optimizing Oracle Financials Cloud using AI and automation for better financial visibility and compliance.",
  registerUrl: "https://forms.google.com/dummy-financials-registration"
},
  {
  title: "Oracle SCM Cloud with AI",
  description: "Comprehensive overview of Oracle SCM Cloud with embedded AI features for predictive planning and intelligent sourcing.",
  originalPrice: "$1,999",
  price: "$999",
  duration: "3 Months",
  mode: "Instructor-guided",
  handsOn: "Practical configuration sessions and AI forecasting simulations",
  overview: "Understand how Oracle SCM Cloud leverages AI to enhance supply chain performance — covering planning, procurement, inventory, and sourcing — while applying data-driven insights for better supplier and demand management.",
  curriculum: [
  ...
  outcomes: "Learn how to configure and utilize Oracle SCM Cloud modules with AI capabilities to drive cost efficiency, reduce risk, and improve supply chain agility.",
  registerUrl: "https://forms.google.com/dummy-scm-registration"
},
  {
  title: "Oracle Cloud HCM",
  description: "Focused learning on Oracle HCM Cloud modules for managing workforce time, attendance, and absence policies with automation and analytics.",
  originalPrice: "$1,999",
  price: "$999",
  duration: "3 Months",
  mode: "Instructor-guided",
  handsOn: "Configuration labs and real-world policy mapping exercises",
  overview: "Explore how Oracle HCM Cloud simplifies workforce operations through Absence Management and Time & Labor modules — helping HR teams automate leave policies, streamline time tracking, and ensure compliance.",
  curriculum: [
  ...
  outcomes: "Acquire hands-on knowledge of Oracle HCM’s time and absence solutions to enhance workforce efficiency, compliance, and data-driven HR operations.",
...
},
{
  ...
  overview: "This program bridges business strategy and AI adoption. Understand practical AI applications for process optimization, forecasting, and insight generation — even without a technical background.",
  curriculum: [
  ...
  outcomes: "Gain a practical understanding of how AI and GenAI reshape operations, enabling faster, smarter, and data-informed decisions across business functions.",
  registerUrl: "https://forms.google.com/dummy-aiops-registration"
},
{
  title: "Data Analysis and Visualization",
  description: "Learn how to interpret, analyze, and visualize data using tools like Power BI, Tableau, and Oracle Analytics Cloud.",
  originalPrice: "$1,999",
  price: "$999",
  duration: "2 Months",
  mode: "Instructor-guided",
  handsOn: "Interactive sessions for data cleaning, dashboarding, and storytelling",
  overview: "Develop analytical and visualization skills to convert raw data into business insights using modern tools and visualization techniques.",
  curriculum: [
  ...
  outcomes: "Build confidence in turning data into insights through visualization and analytics — ready for roles in data analysis, BI, and reporting.",
  registerUrl: "https://forms.google.com/dummy-dataviz-registration"
},
{
  title: "Data Engineering",
  description: "Learn the core principles of modern data engineering — from ETL design to cloud-based pipelines and distributed data processing.",
  originalPrice: "$2,499",
  price: "$1,099",
  duration: "3 Months",
  mode: "Instructor-guided",
  handsOn: "Pipeline building labs and data flow simulations across cloud environments",
  overview: "Understand how data moves, transforms, and scales in enterprise ecosystems. Get exposure to ETL processes, data lakes, warehouses, and modern platforms like Snowflake and Databricks.",
  curriculum: [
  ...
  outcomes: "Develop an applied understanding of modern data engineering workflows and cloud-based architectures commonly used in enterprise data teams.",
